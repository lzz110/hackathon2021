...
class Dashboard extends PureComponent {
  render() {
    ...
    return (
      ...
      >
         <div id="div1">
          <img src="https://img-prod-cms-rt-microsoft-com.akamaized.net/cms/api/am/imageFileData/RWFiiI?ver=a0be&q=60&m=6&h=600&w=1600&b=%23FFFFFFFF&l=f&o=t&aim=true"  />
      ...
      <Row gutter={24}>
        ...
        <Col lg={24} md={24}>
          <div className={styles.chart}>
            <HighChartsComponent type={"Highstock"} />
          </div>
        </Col>
        </Row>
        {/* <Row gutter={24}>
